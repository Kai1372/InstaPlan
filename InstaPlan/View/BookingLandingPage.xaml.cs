...
public partial class BookingLandingPage : ContentPage
{
    public ObservableCollection<string> MenuItems { get; set; }


    public BookingLandingPage()
    {
		InitializeComponent();
    ...
    private async void OnLearnMoreButtonClicked(object sender, EventArgs e)
    {
        await Navigation.PushAsync(new InfoPage());
    }
    private async void ClickGestureRecognizer_DatePicker(object sender, EventArgs e)
    {
        await Navigation.PushAsync(new DateTime());
    }
